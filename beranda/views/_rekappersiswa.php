...
if ($bulan_tahun_pilihplus == '#') {
    ...
    $bulan_tahun_pilihplus = 'rekappersiswa.php?bulan=' . $bulan_tahun_pilihplus;
    $disable = '';
    $ket = 'tidak masuk disable';
}

$title = $title . ' "' . $nama_siswa . '" Bulan ' . $nama_bulan_indo_pilih . ' ' . $tahun_pilih;
            ...
            <div class="col-12">
                <div id="header_rekap" class="card bg-gradient-primary" style="z-index: 1;">
                    <div class="card-body">
                        <div style="display: flex; justify-content: baseline; justify-content: space-between;">
                            <a class="nav-link bg-light bg-gradient-light elevation-2" style="border-radius: 5px;" href="rekappersiswa.php?bulan=<?= $bulan_tahun_pilihmin; ?>"><i class="fas fa-angle-double-left"></i>
                ...
                <div id="header_rekap_pilih" class="card" style="margin-top: -20px;">
                    <ul class="pagination pagination-sm pagination-month" style="justify-content: center; margin: auto;">
                        ...
                        for ($i = 0; $i < 12; $i++) {
                            ...
                            $bulan_pager = 'rekappersiswa.php?bulan=' . $tahun_pilih . '-' . $bul . "&n=" . $nick_get;
                ...
                <div class="card">
                    <div class="card-body mb-5">
                            ...
                            <tbody>
                                ...
                                while ($no < $jumlah_hari) {
                                    ...
                                    if ($harilibur == false && !$deskripsi) {
                                        ...
                                        $sql = "SELECT * FROM datapresensi WHERE tanggal = '$tanggal_pilih' AND nokartu = '$nokartu_siswa'";
                                        ...
                                        if ($status_masuk == 'MSK') {
                                            ...
                                            $status_masuk = '<span class="badge badge-danger">TPM</span>';
                                            $waktu_masuk = "-";
                                            $alpa++;
                                            $tpm++;
                                        }
                                        ...
                                        if ($status_pulang == 'PLG') {
                                            ...
                                            $status_pulang = '<span class="badge badge-danger">TPP</span>';
                                            $waktu_pulang = "-";
                                            $alpa++;
                                            $tpp++;
                                        }
                                        ...
                                        if ($alpa == 2) {
                                            ...
                                            $status_pulang = '<span class="badge badge-danger">A</span>';
                                            $tanpaKeteranngan++;
                                            $tpm--;
                                            $tpp--;
                                        } else {
                        ...
                        <table>
                            Rekap Bulan <?= $nama_bulan_indo_pilih . ' </b> ' . $tahun_pilih; ?>:
                            <tr>
                                <td>Masuk (MSK)</td>
                                <td>: <?= $masuk; ?></td>
                            </tr>
                            ...
                            <tr>
                                <td>Tidak Presensi Masuk (TPM)</td>
                                <td>: <?= $tpm; ?></td>
                            </tr>
                            <tr>
                                <td>Tidak Presensi Pulang (TPP)</td>
                                <td>: <?= $tpp; ?></td>
                            </tr>
                            <tr>
                                <td>Alpa (A)</td>
                                <td>: <?= $tanpaKeteranngan; ?></td>
                            </tr>
                            <tr>
                                <td>Total Keterlambatan</td>
                                <td>: <?= $waktu_telat_siswa; ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
