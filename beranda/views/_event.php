    ...
    foreach ($datasiswa as $siswa) {
        ...
        foreach ($datapresensi as $presensi) {
            ...
            if ($presensi['nis'] == $nis) {
                ...
                $ket_sesi = $presensi['keterangan'];
                $sesi_1 = "";
                $sesi_2 = "";

                if ($ket_sesi === 'DZUHUR') {
                    $sesi_1 = $presensi['mulai'];
                }

                if ($ket_sesi === 'ASHAR') {
                    $sesi_2 = $presensi['mulai'];
                }
                    ...
                    <div class="card-body">
                        <div style="display: flex; justify-content: baseline; justify-content: space-between;">
                            <a class="nav-link bg-light bg-gradient-light elevation-2" style="border-radius: 5px;"
                                href="event.php?bulan=<?= $bulan_tahun_pilihmin; ?>&kelasjur=<?= $kelasjur; ?>"><i
                ...
                <div id="header_rekap_pilih" class="card" style="margin-top: -20px; z-index: 1;">
                    <ul class="pagination pagination-sm pagination-month"
                        ...
                        for ($i = 0; $i < 12; $i++) {
                            ...
                            $bulan_pager = 'event.php?bulan=' . $tahun_pilih . '-' . $bul . "&kelasjur=" . $kelasjur;
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item disabled"
                                        ...
                                        <ul class="submenu dropdown-menu">
                                            ...
                                            <!-- <li><a class="dropdown-item"
                                                    href="?kelasjur=XAT4&bulan=<?= $bulan_tahun_pilih; ?>"> X AT 4 </a>
                                            </li> -->
                                        </ul>
                                    </li>
                                    <li><a class="dropdown-item disabled"
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item disabled"
                                        ...
                                        <ul class="submenu dropdown-menu">
                                            ...
                                            <!-- <li><a class="dropdown-item"
                                                    href="?kelasjur=XDKV4&bulan=<?= $bulan_tahun_pilih; ?>"> X DKV 4
                                                </a></li> -->
                                        </ul>
                                    </li>
                                    <li><a class="dropdown-item disabled"
                ...
                <div class="col-12">
                    <div class="card bg-gradient-primary" style="z-index: 1;">
                        <div class="d-flex justify-content-end m-2">
                            <a target="_blank"
                                href="print_event.php?kelasjur=<?= $kelasjur; ?>&bulan=<?= $bulan_tahun_pilih; ?>&a=print"
                                class="btn btn-dark rounded-0"><i class="fas fa-print"></i>&nbsp;Print</a>
                            <a target="_blank"
                                href="print_event.php?kelasjur=<?= $kelasjur; ?>&bulan=<?= $bulan_tahun_pilih; ?>&a=excel"
                                class="btn btn-success rounded-0"><i class="fas fa-file-excel"></i>&nbsp;Excel</a>
                        </div>
                    </div>
                                    ...
                                    <tr class="perharipertanggal">
                                        ...
                                        for ($k = 1; $k <= $jumlah_hari; $k++) {
                                            ...
                                            if ($harilibur == false && !$deskripsi) {
                                                $hasil_pre = cari_presensi_gabungan($hasil_pencarian, $tanggal_loop, "tanggal", $datasiswa[$j]['nis'], "nis");
                                        ...
                                        ?>
                                                ...
                                                $ket_mulai = (@$hasil_pre[0]['dzuhur']);
                                                $ket_mulai = substr($ket_mulai, 0, 5); // Hasil: "14:23"
                                                $ket_selesai = (@$hasil_pre[0]['ashar']);
                                                $ket_selesai = substr($ket_selesai, 0, 5);
                                                ...
                                                if (strtotime($tanggal_loop) > strtotime($tanggal___)) {
                                                    ...
                                                    if (empty($ket_mulai) && empty($ket_selesai)) {
                                                        ...
                                                        // Normal / parsial
                                                        $keterangan  = "<span class='badge $bg_mulai'>"  . ($ket_mulai   ?: '-') . "</span>";
                                                        $keterangan .= "<span class='badge $bg_selesai'>" . ($ket_selesai ?: '-') . "</span>";
                                                    }


                                                    if (!$ket_mulai && !$ket_selesai) {
                                                        $hasil_ijin = cari_presensi_gabungan($daftarijin, $tanggal_loop, "tanggalijin", $datasiswa[$j]['nis'], "nis");
                                                ...
                                                ?>
                                                    ...
                                                    <td id="setketerangan<?= $nis_datasiswa; ?><?= $tanggal_loop; ?>">
                                                        <a type="button"
                                                            onclick="updateModal('<?= $nis_datasiswa; ?>', '<?= $nama_datasiswa; ?>', '<?= $kelas_datasiswa; ?>', '<?= $tanggal_loop; ?>', '<?= $ket_mulai; ?>', '<?= $ket_selesai; ?>');"
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-2">
                        ...
                        <select id="modal-keteranganmasuk" class="form-select" aria-label="Default select example"
                            ...
                            <option value="M">I - Izin (Menstruasi)</option>
                            <option value="S">S - Sakit</option>
                            <option value="A">A - Tidak Hadir</option>
                        </select>
                    </div>
                    <!--
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        <label for="" class="font-italic font-weight-light"><i class="text-danger">*</i>&nbsp;Wali kelas yang dapat mengubah isian</label><br>
                        <?php if (@$akses_login == "Wali Kelas" || @$akses_login == "admin") { ?>
                            <button type="submit" class="btn btn-primary" id="updateDetailPresensi">Update</button>
...
<script>
    $(document).ready(function() {
        $('#updateDetailPresensi').click(function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: 'app/proses_update_detail_kegiatan.php', // Ganti dengan URL Anda
                data: data,
