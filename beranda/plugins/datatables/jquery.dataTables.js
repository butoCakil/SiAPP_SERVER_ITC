...
(function (factory) {
	...
	(function ($, window, document, undefined) {
		...
		*/
		...
		/**
		 * Draw the header (or footer) element based on the Tampilkan Kolom states. The
		 * methodology here is to use the layout array from _fnDetectHeader, modified for
		 * the instantaneous Tampilkan Kolom, to construct the new layout. The grid is
		...
		*/
		...
		var __details_events = function (settings) {
			...
			if (_pluck(data, '_details').length > 0) {
				...
				// Tampilkan Kolom change - update the colspan
		...
		_api_registerPlural('columns().visible()', 'column().visible()', function (vis, calc) {
			...
			// Group the Tampilkan Kolom changes
			if (vis !== undefined) {
				this.iterator('table', function (settings) {
